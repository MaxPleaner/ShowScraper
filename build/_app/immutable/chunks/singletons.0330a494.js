import { H as d, s as E } from "./index.7346a090.js";
const u = [];
function p(t, e = d) {
  let n;
  const s = new Set();
  function o(a) {
    if (E(t, a) && ((t = a), n)) {
      const c = !u.length;
      for (const l of s) l[1](), u.push(l, t);
      if (c) {
...
function L(t) {
  ...
  for (; r && r !== document.documentElement; )
    n === null && (n = f(r, "preload-code")),
      ...
      e === null && (e = f(r, "noscroll")),
      o === null && (o = f(r, "reload")),
      (r = g(r));
  return {
    preload_code: h[n ?? "off"],
    preload_data: h[s ?? "off"],
    noscroll: e === "off" ? !1 : e === "" ? !0 : null,
...
function v() {
  ...
  async function s() {
    clearTimeout(n);
    const o = await fetch(`${k}/_app/version.json`, {
      headers: { pragma: "no-cache", "cache-control": "no-cache" },
    });
    if (o.ok) {
      const i = (await o.json()).version !== m;
...
function w(t, e) {
  return t.origin !== location.origin || !t.pathname.startsWith(e);
}
function N(t) {
  t.client;
}
