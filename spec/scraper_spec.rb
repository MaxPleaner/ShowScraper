...
RSpec.describe Scraper do
  ...
  describe ".run" do
    context("persist_mode: nil") do
      ...
      it ("gets data for Crybaby") { generic_run_test([Crybaby], 5) }
      it ("gets data for Eagle") { generic_run_test([Eagle], 5) }
      it ("gets data for Midway") { generic_run_test([Midway], 5) }
      it ("gets data for MilkBar") { generic_run_test([MilkBar], 5) }
      it ("gets data for SfJazz") { generic_run_test([SfJazz], 5) }
      it ("gets data for AugustHall") { generic_run_test([AugustHall], 5) }
      it ("gets data for Masonic") { generic_run_test([Masonic], 5) }
      it ("gets data for Paramount") { generic_run_test([Paramount], 5) }
      it ("gets data for FoxTheater") { generic_run_test([FoxTheater], 5) }
      it ("gets data for GreatNorthern") { generic_run_test([GreatNorthern], 15) }
    end
